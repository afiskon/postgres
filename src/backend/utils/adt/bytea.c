...
/*
 * Support structure for bytea sorting
 */
typedef struct
{
...
bytea_abbrev_convert(Datum original, SortSupport ssup)
{
	 ...
	 * keys using HyperLogLog. This is similar to our logic for varlena.
	 */
...
bytea_sortsupport(PG_FUNCTION_ARGS)
{
	...
	/*
	 * Set up abbreviation support if requested and beneficial.
	 */
	if (abbreviate)
	{
